...
const initialWishlist: Product[] = [
  { id: 1, name: 'Fresh Cow Milk', description: 'Pure & fresh cow milk', price: 60, unit: 'Liter', image: require('../assets/images/cow_milk.png'), badge: 'Popular', rating: 4.8, reviews: 234 },
  { id: 4, name: 'Fresh Paneer', description: 'Soft & fresh cottage cheese', price: 120, unit: '500gm', image: require('../assets/images/paneer.png'), badge: 'Fresh', rating: 4.8, reviews: 321 },
  { id: 5, name: 'Pure Ghee', description: 'Traditional bilona ghee', price: 350, unit: '1Ltr', image: require('../assets/images/ghee.png'), badge: 'Pure', rating: 4.9, reviews: 567 },
];
